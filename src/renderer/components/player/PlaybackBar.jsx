    ...
    return (
      <div className="playback-bar">
        ...
        <div className={wrapperClasses}>
          <span className="playback-time-indicator time-progress">{moment.duration(this.state.currentTime, "seconds").format("mm:ss", { trim: false })}</span>
          ...
          <span className="playback-time-indicator time-remaining">-{moment.duration(this.state.remainingTime, "seconds").format("mm:ss", { trim: false })}</span>
